...
const REMIX_IDEAS = [
    "to emulate a famous film director.",
    "to create a passport photo from another country.",
    "to design a vintage travel poster.",
    "to generate a custom comic book cover.",
    "to place yourself on a magazine cover.",
    "to turn your photo into an oil painting.",
];
